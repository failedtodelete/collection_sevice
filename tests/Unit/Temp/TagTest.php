...
class TagTest extends TestCase
{
    ...
    public function testIndexTag()
    {
        ...
        // Отправка запроса
        $response = $this->ajax('GET', 'api/main/tags', [], [], ['auth' => 'agent']);
        return $response
            ->assertStatus(200)
            ->assertJsonStructure([
                'data' => [
    ...
    public function testUpdateTag()
    {
        ...
        $response = $this->ajax('PUT', 'api/temp/tags/1', $new, [], ['auth' => 'admin']);
        return $response
            ->assertStatus(200)
    ...
    public function testDeleteTag()
    {
        ...
        $response = $this->ajax('DELETE', 'api/temp/tags/1', [], [], ['auth' => 'admin']);
        return $response
